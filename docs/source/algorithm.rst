...
gRNA scoring
------------
The gRNAs score is computed from three weights that aim to (1) maximize specifcity, (2) minimize cut-to-insert distance and (3) avoid cutting near splice junctions and 5’ UTRs.
